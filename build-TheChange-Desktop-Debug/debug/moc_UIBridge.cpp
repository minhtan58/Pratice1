...
#include "../../TheChange/App/UIBridge.h"
...
const QMetaObject UIBridge::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UIBridge.data,
      qt_meta_data_UIBridge,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UIBridge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UIBridge.stringdata0))
        return static_cast<void*>(const_cast< UIBridge*>(this));
